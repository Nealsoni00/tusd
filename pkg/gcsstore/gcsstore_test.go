...
import (
	...
	"github.com/Nealsoni00/tusd/v2/pkg/gcsstore"
	"github.com/Nealsoni00/tusd/v2/pkg/handler"
)

//go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/Nealsoni00/tusd/v2/pkg/gcsstore GCSReader,GCSAPI
